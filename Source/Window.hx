...
class Window{
	...
	public function new(x:Float, y:Float, width:Float,height:Float,cursor:Bool){
		this.cursor = cursor;
		if(width < 1)width = 1;
		if(height < 1)height = 1;
		inside = new Bitmap(Assets.getBitmapData("assets/u_window.png"));
